...
knowledge = {
    'topics': {
        # ─────────────────────────────────────────────
        # Priority 1: GREETINGS & FAREWELL (Highest)
        # ─────────────────────────────────────────────
        'greetings': {
            'priority': 1,
            'keywords': ['hi', 'hello', 'hey', 'greetings', 'good morning', 'good evening', 'good afternoon', 'morning', 'evening'],
            'answer': "Hello! 👋 Welcome to EasyLearn Academy. How can I assist you with our courses, fees, timings, or placement details today?"
        },

        'how_are_you': {
            'priority': 1,
            'keywords': ['how are you', 'how r u', 'how do you do', 'how are u'],
            'answer': "I'm doing great, thank you for asking! 😊 I am here to help you with all details about EasyLearn Academy courses, fees, and admissions."
        },

        'thank_you': {
            'priority': 1,
            'keywords': ['thank you', 'thanks', 'thanku', 'thx', 'thank u'],
            'answer': "You're most welcome! 😊 If you have any more questions about our IT courses or admissions, feel free to ask!"
        },

        'identity': {
            'priority': 1,
            'keywords': ['who are you', 'what is your name', 'who u are', 'what you do'],
            'answer': "I am the EasyLearn AI Student Assistant. I can help you with details about our IT courses, fees, duration, batch timings, placements, and academy policies."
        },

        'farewell': {
            'priority': 1,
            'keywords': ['bye', 'goodbye', 'exit', 'quit', 'see you', 'thanks bye'],
            'answer': "Thank you for visiting EasyLearn Academy! 👋 Have a wonderful day, and feel free to reach out to us at 9662512857 anytime!"
        },
...
All courses include practical projects, certificates, and placement support. Contact us for detailed syllabus and current offers."""
        ...
        # ─────────────────────────────────────────────
        # Priority 5: PLACEMENT & CERTIFICATES (High)
        # ─────────────────────────────────────────────
        'certificates': {
            'priority': 5,
            'keywords': ['certificate', 'certification', 'certified', 'degree', 'diploma', 'credential', 'recognition', 'recognized', 'valid', 'government', 'accredited', 'authorized', 'completion certificate', 'course completion', 'industry recognized', 'iso', 'government certified', 'certificate value', 'will i get certificate', 'proof of completion', 'certificate details'],
...
These certificates are industry-recognized and help in job applications and higher studies. We also provide guidance for government-recognized certifications where relevant (e.g., CCC)."""
        ...
        'eligibility': {
            'priority': 5,
            'keywords': ['eligibility', 'eligible', 'qualify', 'qualification', 'who can join', 'requirements', 'criteria', 'minimum', 'degree', 'student', 'fresher', 'beginner', 'experienced', 'professional', 'working', 'college', '12th', 'graduate', 'undergraduate', 'age', 'background', 'can i join', 'prerequisite', 'prior knowledge', 'anyone', 'no experience', 'admission', 'enroll', 'how to join', 'admission process', 'registration'],
...
Admission Process: Visit our office at Eva Surbhi Mall or call 9662512857. Take 3 days free demo classes, fill the registration form, and start! No prior coding experience required."""
        },
